...
if [ ! -f ./opentelemetry-javaagent-all.jar ]; then
    ...
    wget -O opentelemetry-javaagent-all.jar "https://github.com/open-telemetry/opentelemetry-java-instrumentation/releases/latest/download/opentelemetry-javaagent-all.jar"
else
